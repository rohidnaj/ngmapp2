                ...
                {navItems.map((item, index) => (
                  <a
                    ...
                    className={`
                      ...
                      ${currentPage === item.toLowerCase() ? "text-primary font-semibold" : "text-muted-foreground"}
                    `}
                  >
                    {item}
                  </a>
                ))}
                <Button onClick={() => setCurrentPage("quote")} className="bg-primary text-white w-full mt-4">
                  Get Free Quote
                </Button>
              </div>
            </motion.div>
